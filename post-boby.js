// ==================================================
// विजेट 1: Stylish TOC JavaScript for Blogger (v1.1 - Prefixed with stoc-)
// (DOMContentLoaded के भीतर निष्पादित)
// ==================================================
/* ==========================================================================
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const headings = postContentArea.querySelectorAll('h2, h3:not(#stoc-toc-button-header-title), h4, h5, h6');
    ...
    headings.forEach((heading) => {
        ...
        if (heading.closest('#stoc-toc-button-wrapper')) {
             console.log("Skipping heading inside button wrapper:", heading);
             return;
        }
    ...
    if (!hasHeadings) {
        ...
        console.log("Stylish Table of Contents Initialized."); // पुष्टिकरण संदेश
    }
...
// ==================================================
// विजेट 1: Stylish TOC JavaScript for Blogger समाप्त
// ==================================================
